...
import { avgFromEntry, obpFromHitting, slgFromHitting, opsFromHitting, kPctFromHitting, bbPctFromHitting } from '../utils/stats'
...
export const HITTER_COLS = [
  ...
  { label: 'CS',   sortKey: 'caughtStealing',  get: (e) => safeNumber(e.hitting?.caughtStealing) },
  { label: 'HBP',  sortKey: 'hitByPitch',      get: (e) => safeNumber(e.hitting?.hitByPitch) },
  { label: 'SF',   sortKey: 'sacrificeFlies',  get: (e) => safeNumber(e.hitting?.sacrificeFlies) },
  ...
  { label: 'K%',   sortKey: 'kPct',            get: (e) => kPctFromHitting(e.hitting) },
  { label: 'BB%',  sortKey: 'bbPct',           get: (e) => bbPctFromHitting(e.hitting) },
]
